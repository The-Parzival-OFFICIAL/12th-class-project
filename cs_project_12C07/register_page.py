...
def sign():
    con=sql.connect(host="localhost",user='root',password="Joseph1234",database="Cs_project")
    cur=con.cursor()
...
def signup_win():
    ...
    frame_1=Frame(frame,height=1,width=147,bg="#FFFFFF").place(x=171,y=294)#line under the confirm password
